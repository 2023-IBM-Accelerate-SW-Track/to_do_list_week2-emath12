...
const Todos = ({ todos, deleteTodo}) => {
        ...
        <Grid key={todo.id}>
          <Card>
            ...
            <ListItemButton>
              ...
              />
              <ListItemText style={{marginTop:10}} primary={todo.content} secondary={todo.date}></ListItemText>
            </ListItemButton>
          </Card>
        </Grid>
      );
  ...
  return (
    <div deleteTodo={deleteTodo} className="todoCollection" style={{ padding: "10px" }}>
      {todoList}
    </div>
  );
};
